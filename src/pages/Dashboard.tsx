...
import { CheckSquare, LogOut, Plus, Trash2 } from 'lucide-react';
              ...
              <div key={status} className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="space-y-3">
                  {groupedTasks[status].map((task) => (
                    <div
                      key={task.id}
                      className="p-4 rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-blue-50/50 transition-all duration-200 space-y-3"
                    >
                      <div className="flex items-start justify-between gap-3">
                        <p className="text-gray-900 flex-1">{task.title}</p>
                        <button
